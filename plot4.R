...
with(dataKeep, plot(Date, Sub_metering, type = 'n', xlab = "", ylab = "Energy Sub Metering"))
...
with(dataKeep, plot(Date, Voltage, type = 'l', xlab = "datetime", ylab = "Voltage"))

with(dataKeep, plot(Date, Global_reactive_power, type = 'l', xlab = "datetime", ylab = "Global_reactive_power"))
